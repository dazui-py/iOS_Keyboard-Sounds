#!/system/bin/sh
# Keyboard_Sound_IOS — boot-completed.sh
# Executed AFTER sys.boot_completed=1
#
# SUPPORTED BY: KernelSU, KernelSU Next, APatch
# NOT SUPPORTED BY: Magisk (fallback via service.sh)
...
# Apply only keyboard-related sound properties
