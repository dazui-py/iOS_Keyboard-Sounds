#!/system/bin/sh
# Keyboard_Sound_IOS — service.sh
# Executed in late_start service mode.
#
# Purpose:
# 1. Wait until boot is completed
# 2. Re-apply keyboard sound properties via resetprop
#
# This is mainly useful as fallback for environments where boot-completed.sh
# is not used or is unreliable.
...
log "================================================"
log "Keyboard_Sound_IOS service.sh"
...
log "INFO: Boot completed, applying keyboard sound properties."
...
if [ -z "$AUDIO_BASE" ]; then
  log "WARN: No valid audio base path found."
  exit 0
fi
...
log "INFO: Keyboard sound properties applied."
log "================================================"
exit 0om.facebook.katana com.facebook.orca com.facebook.lite com.facebook.mlite com.instagram.android com.instapro.android"
